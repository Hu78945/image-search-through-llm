...
const Module4 = () => {
  ...
  const imageData2 = [
    [
      {imagePath: './icons/module_4a.png', time: 'Monday・September 26, 2023・14:45', source: 'Via Farini, Bologna, Italy'},
      {imagePath: './icons/module_4b.png', time: 'Monday・September 26, 2023・14:45', source: 'Via Farini, Bologna, Italy'},
      {imagePath: './icons/module_4c.png', time: 'Monday・September 26, 2023・14:45', source: 'Via Farini, Bologna, Italy'},
      {imagePath: './icons/module_4d.png', time: 'Monday・September 26, 2023・14:45', source: 'Via Farini, Bologna, Italy'},
      {imagePath: './icons/module_4e.png', time: 'Monday・September 26, 2023・14:45', source: 'Via Farini, Bologna, Italy'}
    ],
    '+11'
  ]
